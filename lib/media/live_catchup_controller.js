...
shaka.media.LiveCatchUpController = class {
  ...
  /**
    ...
    */
  getLatency_() {
    return this.playerInterface_.getPresentationLatency()['latency'] ||
 ...
 *   getPresentationLatency: (function():Object|null),
 ...
 * @property {function():Object|null} getPresentationLatency
