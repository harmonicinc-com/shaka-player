  ...
  async getSegmentReferenceNeeded_(mediaState, presentationTime, bufferEnd) {
    ...
    if (mediaState.segmentIterator) {
      ...
      if (iter &&
        ...
        shaka.log.error('Segment reference invalid');
        // try switching variant
        await this.playerInterface_.refreshManifest();
        // const refIdx = mediaState.stream.segmentIndex.find(timeReq);
        // const ref = mediaState.stream.segmentIndex.get(refIdx);
        mediaState.segmentIterator = null;
        mediaState.stream.segmentIndex = null;
        await mediaState.stream.createSegmentIndex();
        return null;
        // if (ref && ref.startTime <= timeReq && ref.endTime > timeReq) {
        //   return ref;
        // } else {
        //   return null;
        // }
