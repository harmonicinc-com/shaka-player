...
shaka.media.StreamingEngine = class {
  ...
  getProducerReferenceTimeInfo() {
    ...
    let mpdPrtInfo = {};
    let mp4PrftInfo = {
      wca: [undefined, undefined],
      pta: [undefined, undefined],
    };
    ...
    for (const [key, producerReferenceTime] of data.prtMap.entries()) {
      ...
      mpdPrtInfo = {
        type: 'mpd',
        wca: [
          type === 'captured' ? wca : undefined,
          type === 'encoder' ? wca : undefined,
        ],
        pta: [
          type === 'captured' ? pta : undefined,
          type === 'encoder' ? pta : undefined,
        ],
        wc,
      };
      ...
      mp4PrftInfo = {
        type: 'prft',
        wca: [
          type === 'captured' ? wcaPrft : mp4PrftInfo.wca[0],
          type === 'encoder' ? wcaPrft : mp4PrftInfo.wca[1],
        ],
        pta: [
          type === 'captured' ? ptaPrft : mp4PrftInfo.pta[0],
          type === 'encoder' ? ptaPrft : mp4PrftInfo.pta[1],
        ],
        wc,
      };
    }
    return [mpdPrtInfo, mp4PrftInfo];
  }
