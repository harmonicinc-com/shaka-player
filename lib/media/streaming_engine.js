...
shaka.media.StreamingEngine = class {
  ...
  async fetch_(mediaState, reference, streamDataCallback) {
    ...
    mediaState.operation = null;
    this.playerInterface_.onSegmentDownloadCompleted(
        Date.now() - startTime, response.data.byteLength, reference.getUris());
 ...
 *   onSegmentDownloadCompleted: function(number, number, !Array.<string>),
