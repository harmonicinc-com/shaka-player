...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   */
  onSegmentDownloadCompleted(deltaTimeMs, numBytes, uris) {
    if (this.abrManager_) {
      this.abrManager_.segmentDownloadCompleted(deltaTimeMs, numBytes, uris);
    }
  }
  ...
  createStreamingEngine() {
    ...
    const playerInterface = {
      ...
      onSegmentDownloadCompleted: (durationMs, numBytes, uris) =>
