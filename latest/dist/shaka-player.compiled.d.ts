...
declare namespace shaka {
  class Player extends shaka.util.FakeEventTarget implements shaka.util.IDestroyable {
     ...
     */
    getMediaState (contentType : string ) : object | null ;
     ...
     */
    getPresentationLatencyInfo ( ) : shaka.media.StreamingEngine.PresentationLatencyInfo | null ;
    /**
     ...
     */
    getProducerReferenceTimeInfo ( ) : shaka.media.StreamingEngine.ProducerReferenceTimeInfo [] | null ;
    /**
     * Get Service Description
     */
    getServiceDescription ( ) : shaka.extern.ServiceDescription | null ;
    /**
...
declare namespace shaka.abr {
  class SimpleAbrManager implements shaka.extern.AbrManager {
    ...
    segmentDownloadCompleted (deltaTimeMs : any , numBytes : any , uris : any , isFullSpeed : any ) : any ;
    segmentDownloaded (deltaTimeMs : any , numBytes : any , uri : any ) : any ;
...
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.abr {
  class SimpleLLAbrManager implements shaka.extern.AbrManager {
    private noStructuralTyping_shaka_abr_SimpleLLAbrManager : any;
    chooseVariant ( ) : any ;
    configure (config : any ) : any ;
    disable ( ) : any ;
    enable ( ) : any ;
...
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.abr.SimpleLLAbrManager {
  type PlayerInterface = { getPresentationLatencyInfo : ( ( ) => shaka.media.StreamingEngine.PresentationLatencyInfo ) | null , getServiceDescription ? : ( ) => shaka.extern.ServiceDescription } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.abr {
  class SlidingPercentile {
    private noStructuralTyping_shaka_abr_SlidingPercentile : any;
     ...
     */
    addSample (weight : number , value : number ) : any ;
    /**
...
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.media.StreamingEngine {
  type PresentationLatencyInfo = { latency : number , type : string , wallClock : Date | null } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.media.StreamingEngine {
  type ProducerReferenceTimeInfo = { clockOffset : number , inband : boolean , periodStart : number , pta : number , pto : number , timescale : number , type : string , wca : number } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
...
declare namespace shaka.net {
  ...
  class NetworkingEngine extends shaka.util.FakeEventTarget implements shaka.util.IDestroyable {
     ...
     * Each scheme has at most one plugin to handle the request.
     */
    constructor (onProgressUpdated ? : (a : number , b : number , c : string ) => any , onHeadersReceived ? : shaka.net.NetworkingEngine.OnHeadersReceived , onDownloadFailed ? : shaka.net.NetworkingEngine.OnDownloadFailed ) ;
    /**
...
declare namespace shaka.extern {
  ...
  interface AbrManager {
     ...
     */
    segmentDownloadCompleted (deltaTimeMs : number , numBytes : number , uris : string [] , isFullSpeed : boolean ) : any ;
    /**
     ...
     * @param numBytes The total number of bytes transferred.
     */
    segmentDownloaded (deltaTimeMs : number , numBytes : number , uri : string ) : any ;
    /**
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern {
  type DrmInfo = { audioRobustness : string , distinctiveIdentifierRequired : boolean , fetchKey ? : (a : any ) => Promise < any > , initData : shaka.extern.InitDataOverride [] | null , keyIds : Set < string > | null , keySystem : string , keyUri ? : string , licenseServerUri : string , persistentStateRequired : boolean , serverCertificate : Uint8Array | null , serverCertificateUri : string , sessionType : string , videoRobustness : string } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern {
  /**
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern {
  type PresentationLatencyData = { clockOffset : number , periodIdMap : any , prtMap : any } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern {
  type PrtData = { isInBand : boolean , periodStart : number , pta : number , pto : number , type : string , wca : number } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern {
  type ServiceDescription = { latency : shaka.extern.ServiceDescription.Latency | null , playbackRate : shaka.extern.ServiceDescription.PlaybackRate | null , scope : shaka.extern.ServiceDescription.Scope | null } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern.ServiceDescription {
  type Latency = { max : number , min : number , target : number } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern.ServiceDescription {
  type PlaybackRate = { max : number , min : number } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern.ServiceDescription {
  type Scope = { schemeIdUri : string , value : string } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/manifest.js
declare namespace shaka.extern {
...
declare namespace shaka.extern {
  type AbrConfiguration = { advanced : shaka.extern.AdvancedAbrConfiguration , bandwidthDowngradeTarget : number , bandwidthUpgradeTarget : number , defaultBandwidthEstimate : number , enabled : boolean , restrictions : shaka.extern.Restrictions , stallCountToDowngrade : number , switchInterval : number , useNetworkInformation : boolean } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type HlsDateRangeInfo = { class : string | null , customAttributes : shaka.extern.ID3Metadata , duration : number | null , plannedDuration : number | null } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type LiveCatchUpConfiguration = { enabled : boolean , playbackRateMaxOverride : number , playbackRateMinOverride : number , targetLiveLatencyOverride : number } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type TimelineRegionInfo = { endTime : number , eventElement : Element | null , hlsDateRangeInfo : shaka.extern.HlsDateRangeInfo | null , id : string , schemeIdUri : string | null , startTime : number , value : string | null } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
