...
shaka.media.SegmentIndex = class {
   ...
   * EDIT @ 20230608: Deprecate as changed to lazy update. Keep for future
   * Shaka main branch migrations
  ...
  /**
   * Updates the references. It will run once only after fetching &
   * appending a segment.
   */
  update() {}
  /**
...
shaka.net.NetworkingEngine = class extends shaka.util.FakeEventTarget {
  /**
   * @param {function(number, number, string)=} onProgressUpdated
   *   Called when a progress event is triggered. Passed the duration,
   *   in milliseconds, that the request took, and the number of bytes
   *   transferred.
...
shaka.media.PresentationTimeline = class {
  ...
  offset(offset) {}
  /**
   * @return {number} Return total auto corrected drift.
   */
  getAutoCorrectedDrift() {}
  /**
